    ...
    if (isset($_POST['scope'])) {
        ...
        switch ($scope) {
            case "add":
                ...
                //checking if already added in cart or not
                ...
                else 
                {
                    ...
                    //insert query to insert product details into carts table
                    ...
                    if ($insert_query_run) 
                    {
                        echo 201; //Status is okay new recorded is created
                    } 
                    else 
                    {
                        echo 500;
            ...
            case "update":
                ...
                //checking if already existing in user cart or not
                $chk_existing_cart = "SELECT * FROM carts WHERE prod_id='$prod_id' AND user_id='$user_id' ";
